...
public class ClientMessage {
    ...
    public ClientMessage(String IP, int port, MessageType type) {
        this(IP, port, null, type, -1);
    }

    public ClientMessage(String IP, int port, String userMessage) {
        this(IP, port, userMessage, MessageType.MESSAGE, -1);
    }

    public ClientMessage(String IP, int port, String userMessage, MessageType type, long dateTime) {
    ...
    public ClientMessage(String IP, int port, String ownerProperties, MessageType type) {
        this(IP, port, null, ownerProperties, type, -1);
    }

    public ClientMessage(String IP, int port, String transferMessage, String userMessage, MessageType type, long dateTime) {
        this.IP = IP;
        this.port = port;
