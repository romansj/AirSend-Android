...
public class DialogChooseRecipients extends DialogFragment {
    ...
    private ChooseLabelDialogListener listener;
    private EditText editText;
    private boolean wasModified = false;


    public static DialogChooseRecipients newInstance(List<Device> devicesList, List<Device> selectedDevices, ChooseLabelDialogListener listener) {
    ...
    public void setListener(ChooseLabelDialogListener listener) {
    ...
    private AlertDialog getAlertDialog(View dialogView) {
        ...
        dialogBuilder
                ...
                .setNegativeButton(getString(R.string.close), (dialog, which) -> listener.onDialogCancelled());
    ...
    public interface ChooseLabelDialogListener {
